...
public class AlignmentParser {
	...
	public AlignmentParser(PredictionManager predictionManager, BufferedReader br) {
...
//					String frame = gff[7];
					...
					Alignment aln = this.predictionManager.getPredictionDataFactory().buildAlignment();
