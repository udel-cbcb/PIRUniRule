 ...
 */
public class PropagationUtil_2017_07_06 {
...
//					if (debug) {
//						System.out.println(residue.getResidue() + " | " + residue.getPositionInAlignment() + " | " + residue.getPositionInSequence());
//					}
	...
	private static FeatureDescriptionMatch getFeatureDescriptionMatch(UniProtEntry entry, Alignment alignment,
		...
		if (!getFeatureType(entry, alignedSeqStart, alignedSeqEnd, featureDescriptionLine.getFeatureKey()).equals("")) {
			if (!checkPatternMatch(alignedSeqResidues, conditionPattern)) {
				...
				if (!getFeatureType(entry, alignedSeqStart, alignedSeqEnd, featureDescriptionLine.getFeatureKey()).equals(
					...
					if (!getFeatureDescription(entry, alignedSeqStart, alignedSeqEnd, featureDescriptionLine.getFeatureKey()).contains(
	...
	public static boolean checkNonControlBlockScope(PIRRule rule, String organism) {
