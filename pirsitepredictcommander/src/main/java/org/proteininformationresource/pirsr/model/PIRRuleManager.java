...
public interface PIRRuleManager {
	 ...
	 */
	List<PIRRule> parsePIRRules(URL url, Format format, Boolean isStrict, String lineNumberType);
	 ...
	 * @return a list of <code>PIRRule</code>
	 */
	List<PIRRule> parsePIRRules(File file, Format format, Boolean isStrict, String lineNumberType);
	 ...
	 * @return a list of <code>PIRRule</code>
	 */
	List<PIRRule> parsePIRRules(InputStream inputStream, Format format, Boolean isStrct, String lineNumberType);
